package com.shubhangi.covidstatus;
...
import static com.shubhangi.covidstatus.StatewiseDataActivity.STATE_CONFIRMED;
import static com.shubhangi.covidstatus.StatewiseDataActivity.STATE_NAME;
import static com.shubhangi.covidstatus.StatewiseDataActivity.STATE_ACTIVE;
import static com.shubhangi.covidstatus.StatewiseDataActivity.STATE_DECEASED;
import static com.shubhangi.covidstatus.StatewiseDataActivity.STATE_NEW_CONFIRMED;
import static com.shubhangi.covidstatus.StatewiseDataActivity.STATE_NEW_RECOVERED;
import static com.shubhangi.covidstatus.StatewiseDataActivity.STATE_NEW_DECEASED;
import static com.shubhangi.covidstatus.StatewiseDataActivity.STATE_LAST_UPDATE;
import static com.shubhangi.covidstatus.StatewiseDataActivity.STATE_NOTES;
import static com.shubhangi.covidstatus.StatewiseDataActivity.STATE_RECOVERED;

public class PerStateData extends AppCompatActivity {

    TextView perStateConfirmed, perStateActive, perStateDeceased, perStateNewConfirmed, perStateNewRecovered, perStateNewDeceased, perStateUpdate, perStateRecovered, perstateName, perStateNotes;
    PieChart mPieChart;
    String stateName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String stateNotes= intent.getStringExtra(STATE_NOTES);
        ...
        perStateNotes=findViewById(R.id.per_state_note);
        ...
        perStateNotes.setText(stateNotes);
