...
public class MainActivity extends AppCompatActivity {
    ...
    TextView textView_confirmed, textView_confirmed_new,textView_active,textView_state_note, textView_active_new, textView_recovered, textView_recovered_new, textView_death, textView_death_new, textView_tests, textView_date, textView_tests_new, textview_time;
...
//        SharedPreferences sharedPreferences = getSharedPreferences("prefs", MODE_PRIVATE);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.info) {
            ...
            new AlertDialog.Builder(this, R.style.CustomDialog)
                 ...
                 .setMessage("Developer:Shubhangi Borole")
    ...
    public void onBackPressed() {
        ...
        if (backPressTime + 700 > System.currentTimeMillis()) {
            backToast.cancel();
            super.onBackPressed();
            return;
        } else {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (isRefreshed) {
                        ...
                        stateNotes = statewise.getString("statenotes");
