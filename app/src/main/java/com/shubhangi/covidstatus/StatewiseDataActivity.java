...
public class StatewiseDataActivity extends AppCompatActivity implements StatewiseAdapter.OnItemClickListner {
    ...
    public static final String STATE_NOTES = "stateNotes";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_state_note = findViewById(R.id.per_state_note);
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i = 1; i < jsonArray.length(); i++) {
                        ...
                        String stateNotes = statewise.getString("statenotes");
                        ...
                        statewiseModelArrayList.add(new StatewiseModel(stateName, stateConfirmed, stateActive, stateDeceased, stateNewConfirmed, stateNewRecovered, stateNewDeceased, stateNotes,stateLastUpdate, stateRecovered));
                    }
    ...
    public void onItemClick(int position) {
        ...
        perStateIntent.putExtra(STATE_NOTES,clickedItem.getNotes());
    ...
    public void showProgressDialog() {
        ...
        Runnable progressRunnable = new Runnable() {
            ...
            public void run() {
                if (confirmation != 1) {
                    progressDialog.cancel();
                    Toast.makeText(StatewiseDataActivity.this, "Slow internet connection", Toast.LENGTH_SHORT).show();
                }
            }
        };
        Handler pdCanceller = new Handler();
